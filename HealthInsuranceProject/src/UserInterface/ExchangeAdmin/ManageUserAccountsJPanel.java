...
public class ManageUserAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountsJPanel(JPanel userProcessContainer,UserAccount userAccount) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
      
        this.userAccount = userAccount;
        userAccountDirectory = userAccount.getExchangeEnterprise().getUserAccountDirectory();
        Refresh();
    }
    public void Refresh()
    {
    ...
    private void addjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addjButtonActionPerformed
        ...
        userProcessContainer.add("addUA",addUserAccountJPanel);
